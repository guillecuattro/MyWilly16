      ...
      const html = `<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8">
        ...
        <table>
          ...
          <tbody>${allRows.map(s=>{
            ...
            return \`<tr>
              <td>${s.date}</td>
              <td>${Number(s.partic||0).toFixed(4)}</td>
              <td>${Number(s.nav||0).toFixed(4)}&euro;</td>
              <td>${inv2.toFixed(2)}&euro;</td>
              <td>${mkt2.toFixed(2)}&euro;</td>
              <td style="color:${res>=0?"#2e7d32":"#c62828"}">${res>=0?"+":""}${res.toFixed(2)}&euro;</td>
            </tr>\`;
          }).join("")}
          <tr class="total">
